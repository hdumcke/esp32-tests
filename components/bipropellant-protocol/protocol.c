...
const static PARAMSTAT initialparams[] = {
    ...
    { 0x72, "servo get enable status", NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingReadOnly },
    { 0x73, "servo set position",      NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingPreWriteClear },
    { 0x74, "servo get get position",  NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingReadOnly },
    { 0x75, "servo get get feedback",  NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingReadOnly },
    { 0x76, "servo get get speed",     NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingReadOnly },
    { 0x77, "servo get get load",      NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingReadOnly },
    { 0x78, "servo get get voltage",   NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingReadOnly },
    { 0x79, "servo get get temper",    NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingReadOnly },
    { 0x7A, "servo get get move",      NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingReadOnly },
    { 0x7B, "servo get get current",   NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingReadOnly },
    { 0x7C, "servo ping",              NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingReadOnly },
    { 0x7D, "imu read 6dof",           NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingReadOnly },
    { 0x7E, "imu read attitude",       NULL,  UI_NONE,  &contentbuf, sizeof(PROTOCOL_SENSOR_FRAME),        fn_defaultProcessingReadOnly },
